  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="border-primary/20 hover:shadow-premium transition-shadow duration-300 animate-fade-in">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold mb-3">30+ Mahsulotlar</h3>
                <p className="text-muted-foreground">
                  30 xildan ortiq plastik mahsulotlarni ishlab chiqaramiz
                </p>
              </CardContent>
            </Card>
          ...
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold mb-6">{t("home.aboutCompany")}</h2>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">{t("home.ourProducts")}</h2>
      ...
      <section className="py-20 bg-background overflow-hidden">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">{t("home.ourPartners")}</h2>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">{t("home.certificates")}</h2>
      ...
      <section id="contact" className="py-20 bg-background">
        <div className="container mx-auto px-4 max-w-2xl">
          <h2 className="text-4xl font-bold text-center mb-12">{t("home.contactUs")}</h2>
